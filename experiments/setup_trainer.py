...
def setup_trainer(config: TrainingConfig):
    ...
    trainer = TrainerSegmentation(
        ...
        validation_segmentations_folder=config.validation_segmentations_folder,
        testing_images_folder=config.testing_images_folder,
        testing_segmentations_folder=config.testing_segmentations_folder,
